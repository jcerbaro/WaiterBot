...
rule::rule()
{
 inputcat1 = inputcat2 = inputcat3 = inputcat4 = inputcat5 = outputcat = NULL;
}
...
// definerule(category*,category*,category*,category*) - Defines a rule with three
// input sets and one output set!
void rule::definerule(trapezoid_category *input1,trapezoid_category *input2,
                      trapezoid_category *input3,trapezoid_category *input4,
                      trapezoid_category *input5, trapezoid_category *output)
{
inputcat1 = input1;
inputcat2 = input2;
inputcat3 = input3;
...
// idem for three inputs! Use a t_norm to calculate!
float rule::evaluaterule(float &inputval1, float &inputval2, float &inputval3, float &inputval4, float &inputval5)
{
 float x=tnorm(inputcat1->getshare(inputval1), inputcat2->getshare(inputval2));
 float y=tnorm(x,inputcat3->getshare(inputval3));
 float z=tnorm(y,inputcat4->getshare(inputval4));
 return(tnorm(z,inputcat5->getshare(inputval5)));
}
...
void rule::clearinputcategoryactivations()
{
      ...
      if(inputcat4!=NULL) inputcat4->clearoutput();
      if(inputcat5!=NULL) inputcat5->clearoutput();
}
...
if(inputcat4)
   fprintf(file, " %d",inputcat4->getnumber()+1);
if(inputcat5)
   fprintf(file, " %d",inputcat5->getnumber()+1);
 fprintf(file, ", ");
